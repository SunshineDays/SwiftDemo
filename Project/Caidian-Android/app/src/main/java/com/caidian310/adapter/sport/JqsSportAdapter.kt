 ...
 */
class JqsSportAdapter(context: Context, list: ArrayList<MatchBean>) : BaseAdapter<MatchBean>(context, list) {
    override fun getItemLayoutId(position: Int) = R.layout.item_sport_jqs
