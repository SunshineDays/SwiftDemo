 ...
 */
class CopyOrderFollowBetAdapter(var context: Context, var list: ArrayList<PayMatch>) : RecyclerView.Adapter<CopyOrderFollowBetAdapter.ViewHolder>() {
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        init {
            name = view.findViewById(R.id.item_pay_detail_name)
            home = view.findViewById(R.id.item_pay_detail_home_name)
            away = view.findViewById(R.id.item_pay_detail_home_away)
            score = view.findViewById(R.id.item_pay_detail_score)
            content = view.findViewById(R.id.item_pay_detail_content)
        }
    }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_pay_record, parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        val payMatchInfo = list[position]
