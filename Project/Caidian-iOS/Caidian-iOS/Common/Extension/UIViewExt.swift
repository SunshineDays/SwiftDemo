...
public enum BorderPositionType {
    case top
    case right
    case bottom
    case left
...
extension UIView {
    ...
    public func addBorder(position: BorderPositionType, borderWidth: CGFloat, color: UIColor, insets: UIEdgeInsets = UIEdgeInsets.zero) {
        let leftOffset = insets.left
        let rightOffset = insets.right
        ...
        switch position {
        case .top:
            borderFrame = CGRect(x: leftOffset, y: topOffset, width: frame.size.width - leftOffset - rightOffset, height: borderWidth)
        case .right:
            borderFrame = CGRect(x: frame.size.width - borderWidth - rightOffset, y: topOffset, width: borderWidth, height: frame.size.height - topOffset - bottomOffset)
        case .bottom:
            borderFrame = CGRect(x: leftOffset, y: frame.size.height - borderWidth - bottomOffset, width: frame.size.width - leftOffset - rightOffset, height: borderWidth)
        case .left:
            borderFrame = CGRect(x: leftOffset, y: topOffset, width: borderWidth, height: frame.size.height - topOffset - bottomOffset)
        }
