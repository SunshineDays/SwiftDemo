...
/// 弹窗
class TSPopoverContentViewController: UITableViewController {
    ...
    var onPopoverItemClick: ((_ index: Int) -> Void)?
...
extension TSPopoverContentViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        label.text = dataSource[(indexPath as NSIndexPath).row]
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        onPopoverItemClick?((indexPath as NSIndexPath).row)
