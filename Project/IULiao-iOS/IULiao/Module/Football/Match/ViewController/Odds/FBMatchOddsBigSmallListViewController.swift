...
/// 赛事分析页 指数 亚盘列表
class FBMatchOddsBigSmallListViewController: TSEmptyViewController, TSNestInnerScrollViewProtocol, FBMatchViewControllerProtocol {
    ...
    private var oddsList = [FBOddsBigSmallSetModel]()
...
extension FBMatchOddsBigSmallListViewController {
...
extension FBMatchOddsBigSmallListViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.configCell(bigSmall: bigSmall, needBackgroundColor: row % 2 == 0)
        return cell
    }
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let bigSmall = oddsList[indexPath.row]
        let ctrl = TSEntryViewControllerHelper.fbMatchOddsBigSmallCompanyViewController(matchId: matchId, companyId: bigSmall.company.id, lottery: lottery)
