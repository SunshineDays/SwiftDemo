...
extension UserLoginViewController {
    ...
    func initView() {
        ...
        phoneTextField1.attributedPlaceholder = NSAttributedString(string: "请输入您的手机号", attributes: [NSAttributedStringKey.foregroundColor: color])
        passwordTextField.attributedPlaceholder = NSAttributedString(string: "请输入您的密码", attributes: [NSAttributedStringKey.foregroundColor: color])
        phoneTextField2.attributedPlaceholder = NSAttributedString(string: "请输入您的手机号", attributes: [NSAttributedStringKey.foregroundColor: color])
        codeTextField.attributedPlaceholder = NSAttributedString(string: "请输入您的验证码", attributes: [NSAttributedStringKey.foregroundColor: color])
    ...
    func login() {
        ...
        case .password:
            ...
            guard let password = passwordTextField.text, password.count != 0 else {
                TSToast.showNotificationWithMessage("请输入密码", colorStyle: .error)
    ...
    func loginSuccess(userInfo: UserInfoModel) {
       //
        ...
        dismiss(animated: true, completion: nil)
        TSToast.showNotificationWithTitle("登录成功", colorStyle: .success)
